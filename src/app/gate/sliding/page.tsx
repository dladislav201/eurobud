    ...
    <main className="main flex gate">
      ...
      <section className="product-banner" data-switch-parent>
        <div className="wrapper inline-wide">
          <h1 className="product-banner-title">Відкатні ворота</h1>
        </div>
        <div className="product-hero-container">
          <video
            id="switchVideo"
            className="product-hero-video"
            poster="/img/gate-sliding-poster.jpg"
            autoPlay
            playsInline
            muted
            loop
          >
            <source src="/video/gate-sliding-clip.mp4" type="video/mp4" />
          </video>
        </div>
