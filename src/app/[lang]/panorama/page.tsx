        ...
        <div id="productGallery" className="product-gallery">
          ...
          >
            ...
            <li id="galleryItem" className="gallery-item second-anim">
              ...
              <div className="typography-wrapper">
                <p className="description">
                  <span className="dark-span">Автоматичні гільйотини</span> або
                  вертикально-зсувні системи: горизонтальні стулки рухаються
                  вгору та вниз за допомогою електроприводу. Керування
                  здійснюється за допомогою спеціального пульта.
                </p>
                <Link className="item-link" href="/conversation">
                  Замовити розрахунок
                  <span className="material-symbols-outlined medium">
        ...
        <div className="product-features-block energy-efficiency">
          ...
          <div className="wrapper inline-narrow">
            <p className="description medium">
              Системи витримують температури від -30 °C до +45 °C, забезпечуючи
              комфортний мікроклімат всередині приміщення навіть при
