...
interface PriductGalleryprops {
  automaticModels: AutomaticModel[];
}

export const ProductGallery = ({ automaticModels }: PriductGalleryprops) => {
  return (
    <>
      <div id="productGallery" className="product-gallery">
        <ul id="galleryContainer" className="gallery-items-container">
          {automaticModels.map((automaticModel, index) => (
            <li
              key={index}
              id="galleryItem"
              className="gallery-item first-anim"
            >
              <div className="content-container">
                ...
                <div className="product-typography-wrapper">
                  ...
                  <p className="product-pricing">{automaticModel.price}</p>
                </div>
                <div className="product-picture-container levigato">
                  {/* <picture className="picture" style={}></picture> */}
                  <img className="picture" src={automaticModel.imageUrl} />
                </div>
                <div className="product-action-content">
                  <a
                    href="/conversation"
                    className="btn automatic-producr-btn buy"
                  >
                    Замовити
                  </a>
                  <button
                    id="openCardBtn"
                    className="btn automatic-producr-btn more"
                  >
                    Характеристики
                  </button>
                </div>
      ...
      <div className="product-gallery-btn-container">
        <div className="btn-groove">
          <button id="galleryPrvBtn" className="btn-chevron" disabled>
          ...
          <button id="galleryNxtBtn" className="btn-chevron">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
